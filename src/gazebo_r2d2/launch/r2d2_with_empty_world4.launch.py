...
def generate_launch_description():
    ...
    xacro_file = os.path.join(gazebo_r2d2_prefix,'urdf','r2d2_ros2_control_in_gazebo.urdf.xacro')
    ...
    load_diff_drive_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'start', robot_controller],
        output='screen'
    )
    return LaunchDescription([
        ...
        # unnecessary controller manager
        # Node(
